import { Target, CheckCircle, Scale, Download, ArrowRight, Palette, MessageSquare } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          >
            ...
            <span>Digital Marketing for Your Startup</span>
          </button>
        </div>

        {/* Logo Design & Name Button */}
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <button
            onClick={() => navigate('/logo-design', { state: { domain: results.primaryDomain } })}
            className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-4 rounded-lg font-semibold hover:from-purple-700 hover:to-pink-700 transition-colors flex items-center justify-center gap-2"
          >
            <Palette className="w-5 h-5" />
            <span>Logo Design & Name Suggestions</span>
          </button>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-colors flex items-center gap-2"
            >
